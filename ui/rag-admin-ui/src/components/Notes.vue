    ...
    <div class="rag-card flex-1 min-h-0 flex flex-col gap-4">
      ...
      <div class="grid flex-1 gap-4 md:grid-cols-[minmax(0,0.4fr)_minmax(0,0.6fr)]">
        <div class="flex flex-col gap-4 min-h-0">
          <NotesList :notes="visibleNotes" :isLoading="isLoading" :errorText="errorText" :selectedId="selectedId"
            @select="selectNote" @delete="deleteNote" />


          <button v-if="canShowMore" type="button"
